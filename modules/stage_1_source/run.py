...
from shared.utils.io import ROOT, read_json, read_jsonl, repo_path, sha256_file, utc_now, write_jsonl
...
def run_stage(run_dir: Path, config: dict[str, Any], experiment_manifest: Path, command: list[str]) -> None:
    ...
    schema_path = ROOT / "modules" / "stage_1_source" / "schemas" / "source_descriptor.schema.json"
