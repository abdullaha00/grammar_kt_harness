...
This repository is the isolated prospective EGP normalization v1.3 pilot.

- Files covered by `FROZEN_MANIFEST.sha256` are immutable after the freeze
  commit. Preserve defects as outcomes; never repair frozen inputs during the
  run.
